...
<!--					<div class="menu-star"></div>-->
		...
		<div class="rules" v-if="levelClosedShow">
			<cross-vue @click.native="toggleLevelClosedShow()" class="shop__cross"></cross-vue>
...
<!--			</div>-->
		...
		<div class="rules" v-if="showInfoAboutPortrait">
			<cross-vue @click.native="toggleShowInfoAboutPortrait()" class="shop__cross"></cross-vue>
			<h2 class="rules__menu">
		...
		<div class="rules shop rules_lb" v-show="isLeaderBoard">
			<cross-vue @click.native="toggleLeaderBoard()" class="shop__cross"></cross-vue>
		...
		<div class="game" v-show="content">
			...
			<div class="rules shop word-mean" v-show="showWordDesc">
				<cross-vue @click.native="toggleShowWordDesc()" class="shop__cross"></cross-vue>
				<h2 class="rules__menu">
			...
			<div class="rules shop whyBadWord" v-show="showWhyBadWord">
				<cross-vue @click.native="toggleShowWhyBadWord()" class="shop__cross"></cross-vue>
				<h2 class="rules__menu">
			...
			<div class="rules" v-show="showAdvError">
				<cross-vue @click.native="toggleShowAdvError()" class="shop__cross"></cross-vue>
				<h2 class="rules__menu">
